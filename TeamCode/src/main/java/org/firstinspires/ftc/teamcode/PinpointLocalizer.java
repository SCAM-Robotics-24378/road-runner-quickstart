...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -6.8125; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 7.0625; // x position of the perpendicular encoder (in tick units)
    }
